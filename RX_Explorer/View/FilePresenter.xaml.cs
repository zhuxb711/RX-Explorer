...
namespace RX_Explorer
{
    public sealed partial class FilePresenter : Page, IDisposable
    {
        ...
        public FileSystemStorageFolder CurrentFolder
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    if(value.Path != Globalization.GetString("MainPage_PageDictionary_ThisPC_Label")) { 
        ...
        private void LibraryGrid_ContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
        {
            if (args.InRecycleQueue)
            {
                args.ItemContainer.PointerEntered -= LibraryItemContainer_PointerEntered;
            }
            else
            {
                args.ItemContainer.PointerEntered += LibraryItemContainer_PointerEntered;
        ...
        private void LibraryItemContainer_PointerEntered(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            if (!SettingControl.IsDoubleClickEnable)
            {
        ...
        public async Task OpenTargetFolder(StorageFolder Folder)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    await DisplayItemsInFolder(Folder.Path);
        ...
        public async void DeviceRefresh_Click(object sender, RoutedEventArgs e)
        {
