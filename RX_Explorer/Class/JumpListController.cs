        ...
        public static async Task AddItemAsync(JumpListGroup Group, params string[] FolderPathList)
        {
            ...
            if (FolderPathList.Length > 0)
            {
                ...
                foreach (string FolderPath in FolderPathList)
                {
                    ...
                    NewItem.Logo = WindowsVersionChecker.IsNewerOrEqual(WindowsVersion.Windows11) ? new Uri("ms-appx:///Assets/FolderIcon_Win11.png") : new Uri("ms-appx:///Assets/FolderIcon_Win10.png");
